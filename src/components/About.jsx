        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div ref={headRef}>
            ...
            <motion.h2
              ...
              className="text-3xl lg:text-4xl font-800 text-gray-900 mb-5 leading-tight"
            >
              Your Trusted Dental
              <br />
            ...
            >
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>Shop No. 04, Heera Panna Apartment,<br />Pandey Dairy Chowk, Jalgaon – 425001</span>
              </div>
            </motion.div>
            ...
            >
              <a
                href="#contact"
                id="about-book-btn"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-[#0ea0b8] to-[#0c6d85] text-white text-sm font-600 shadow-md hover:shadow-lg hover:scale-105 transition-all duration-200 whitespace-nowrap"
              >
                Book Appointment
              </a>
              <a
                href="tel:8623015615"
                id="about-call-btn"
                className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white border border-gray-200 text-gray-700 text-sm font-600 hover:border-[#0ea0b8] hover:text-[#0ea0b8] transition-all duration-200 whitespace-nowrap"
              >
